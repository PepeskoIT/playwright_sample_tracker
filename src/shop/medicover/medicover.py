...
from shop.medicover import definitions


class MedicoverBuy(BasePwBuy):
    def __init__(self, **kwargs):
        super().__init__(
            ...
            captcha_locator=None, captcha_text=None,
            captcha_img_locator=None,
            **kwargs
        )
    ...
    async def ensure_login(self):
        ...
        if self.page.url == self.login_url:
            self.page.locator(definitions.LOGIN_INIT_BUTTON).click
            await super().login()
